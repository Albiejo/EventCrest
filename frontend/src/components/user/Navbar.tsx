...
const MyNavbar=()=> {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography as="li" variant="h6" color="white" className="flex items-center gap-x-2 p-1 font-medium" placeholder={undefined}  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
  ...
  return (
    <Navbar className=" px-4 lg:px-8 lg:py-2 lg:mb-6 bg-dark " placeholder={undefined} style={{background:"#446879" , margin: "-12px" }}  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} >
