...
import { HomeIcon  , ShoppingCartIcon , i} from "@heroicons/react/24/solid";
  ...
  return (
    <Navbar className="px-4 lg:px-8 lg:py-2 lg:mb-6 max-w-screen-3xl" placeholder={undefined} style={{ borderRadius: 0, border: 0 }}>
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
       ...
       {/* <img src="../../../public/imgs/logo.png" alt="" class="w-25 h-16 " /> */}
       Event Crest
        </Typography>
        ...
        <div className="flex items-center gap-x-1">
          {isUserSignedIn?<><Button variant="gradient"  size="sm" className="hidden lg:inline-block" placeholder={undefined} onClick={handleLogout}><span>Logout</span></Button> 
          <Link to="/profile"><Button placeholder={undefined} variant="gradient"  size="sm" className="hidden lg:inline-block">Profile</Button></Link></>
       :  <><Link to="/login"><Button variant="text" color="white" size="sm" className="hidden lg:inline-block" placeholder={undefined}><span>Log In</span> </Button></Link>
